  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.status === 201) {
        console.log('Fund Edited');
      }
      Alert.alert(
        'Success',
        'Funding campaign edited successfully',
        [
          {
            text: 'View Campaign',
            onPress: () => router.back()
      ...
      Alert.alert('Error', 'Failed to edit funding campaign');
  ...
  return (
    <PaperProvider theme={enhancedTheme}>
      <SafeAreaView className="flex-1 bg-gray-50">
        <EventHeader Heading={'Edit Funding Campaign'} />
        <ScrollView>
          <LinearGradient
          ...
          >
            <View className="items-center">
              <Text className="text-4xl font-bold text-white text-center mb-3">Edit Funding Campaign</Text>
